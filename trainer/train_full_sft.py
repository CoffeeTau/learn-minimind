...
if __name__ == "__main__":
    ...
    parser.add_argument('--from_weight', default='pretrain', type=str, help="基于哪个权重训练，为none则不基于任何权重训练") # sft模型的起点是pretrain_768.pth
    ...
    # SFT没有换一套 Transformer，仍然使用 MiniMindForCausalLM，变化主要是发生在数据组织和标签掩码上
